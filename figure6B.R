...
i = fread('/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref/output/signature/ID83/Suggested_Solution/COSMIC_ID83_Decomposed_Solution/Activities/COSMIC_ID83_Activities_refit.txt')

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref/plot'
if(!dir.exists(output.dir)){dir.create(output.dir)}

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref/plot/indel.sig'
if(!dir.exists(output.dir)){dir.create(output.dir)}
...
group.level = c('X-ray_WT', 'X-ray_LIG4-MT', 'X-ray_POLQ-MT', 'Carbon-ion_WT', 'Carbon-ion_LIG4-MT', 'Carbon-ion_POLQ-MT', 'Fe-ion_WT', 'Fe-ion_LIG4-MT', 'Fe-ion_POLQ-MT')
...
colors = c('#d02127', '#f26622', '#97c53e', '#516db5', '#7e4e9f')
...
pdf(file=file.path(output.dir, 'sig.indel.ratio.strip.wt.lig4.polq.bar.plot.pdf'), width=200, height=60)
...
pdf(file=file.path(output.dir, 'sig.indel.ratio.strip.wt.lig4.polq.bar.plot.legend.pdf'), width=200, height=60)
legend
dev.off()
