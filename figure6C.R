...
i = fread('/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref.sv/output/signature/ID83/Suggested_Solution/COSMIC_ID83_Decomposed_Solution/Activities/COSMIC_ID83_Activities_refit.txt')

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref.sv/plot'
if(!dir.exists(output.dir)){dir.create(output.dir)}

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref.sv/plot/indel.sig'
if(!dir.exists(output.dir)){dir.create(output.dir)}
...
colors = c('#d02127', '#f26622', '#efeb40', '#97c53e', '#516db5', '#7e4e9f')
