...
i = fread('/BiO/Research/UNIST-HPRT-SIG-2020-1028/part10/output/sigProfilerExtractor.only.sv/output/signature/ID83/Suggested_Solution/COSMIC_ID83_Decomposed_Solution/Activities/COSMIC_ID83_Activities_refit.txt')

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part10/output/sigProfilerExtractor.only.sv/plot'
if(!dir.exists(output.dir)){dir.create(output.dir)}

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part10/output/sigProfilerExtractor.only.sv/plot/indel.sig'
if(!dir.exists(output.dir)){dir.create(output.dir)}
...
pdf(file=file.path(output.dir, 'sig.indel.bar.count.long.v4.pdf'), width=80, height=100)
ggplot(df2, aes(x=Sample, y=Count)) +
	...
	scale_fill_manual(values = c("ID1" = "#d02127", "ID5" = "#f26622", "ID6" = "#efeb40", 
							...
							"ID2" = "#e91e63", "ID3" = "#1b2a6b", "ID83A" = "#97c53e")) +
...
pdf(file=file.path(output.dir, 'sig.indel.bar.proportion.long.v4.pdf'), width=80, height=100)
