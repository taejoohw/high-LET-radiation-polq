...
i = fread('/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref/output/ID/sigProfilerExtractor.ref.ID83.all')
meta = fread('/BiO/Research/UNIST-HPRT-SIG-2020-1028/20250112.sample.list.txt')

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part8/output/sigProfilerExtractor.ref/plot/indel/figure4'
...
df2$MutationType = factor(df2$MutationType, levels=c('1bp_Deletion', '1bp_Insertion', 'Repeat_Deletion', 'Repeat_Insertion', 'Microhomology'))
...
colors = c('#f5821f', '#36a248', '#bd2026', '#1764aa', '#64429a')
...
pdf(file=file.path(output.dir, 'indel.5class.barplot.figure4.pdf'), width=120, height=40)
...
pdf(file=file.path(output.dir, 'indel.5class.barplot.legend.figure4.pdf'), width=120, height=40)
legend
dev.off()
