...
i = fread('/BiO/Research/UNIST-HPRT-SIG-2020-1028/part10/output/sigProfilerExtractor.id.sv/output/signature/ID83/Suggested_Solution/COSMIC_ID83_Decomposed_Solution/Activities/COSMIC_ID83_Activities_refit.txt')

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part10/output/sigProfilerExtractor.id.sv/plot'
if(!dir.exists(output.dir)){dir.create(output.dir)}

output.dir = '/BiO/Research/UNIST-HPRT-SIG-2020-1028/part10/output/sigProfilerExtractor.id.sv/plot/indel.sig'
if(!dir.exists(output.dir)){dir.create(output.dir)}
...
#no.df = data.frame(no.samples, 0, 0, 0, 0, 0)
...
df2 = df2[df2$Signature %in% c('ID1', 'ID5', 'ID8'),]

length(unique(df2$Signature))
#[1] 3

pdf(file=file.path(output.dir, 'sig.indel.bar.count.extended.v4.pdf'), width=80, height=100)
...
pdf(file=file.path(output.dir, 'sig.indel.bar.proportion.extended.v4.pdf'), width=80, height=100)
